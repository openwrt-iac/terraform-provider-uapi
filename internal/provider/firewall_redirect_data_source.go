		...
		Attributes: map[string]dsschema.Attribute{
			...
			"match": dsschema.SingleNestedAttribute{
				...
				Attributes: map[string]dsschema.Attribute{
					...
					"src_dport": dsComputedString("With target DNAT, the incoming (destination) port or range to redirect. With target SNAT, the source port to rewrite to."),
					"src_dip":   dsComputedString("With target DNAT, the external destination address to match, which also selects the address used for NAT reflection. With target SNAT, the address to rewrite the source to, and required."),
					"dest_ip":   dsComputedString("Internal destination address to rewrite to."),
					"dest_port": dsComputedString("Internal destination port or range to rewrite to."),
