...
func (r *networkRouteResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"interface": optionalComputedString("Parent network interface name."),
			...
			"target":    schema.StringAttribute{Required: true, Description: "Destination IPv4 address or CIDR for this route."},
