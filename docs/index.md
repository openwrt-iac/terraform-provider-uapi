...
description: |-
  Manage OpenWrt configuration through the uapi REST API. Only curated endpoints are exposed; the /raw passthrough is intentionally not supported. See the uapi project https://github.com/openwrt-iac/uapi for the API this provider wraps.
---
